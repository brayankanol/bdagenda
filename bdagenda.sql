...
CREATE TABLE agenda
 (codigoper                  VARCHAR(3)  NOT NULL,
  ...
  CONSTRAINT agenda_codigoper_fk FOREIGN KEY (codigodis) REFERENCES distrito(codigodis);

INSERT INTO distrito VALUES (1,'Chimbote'),(2,'Nvo Chimbote');
...
'043411742', '974410547','giancarlosarrines@hotmail.com', 'giancarlo sarrin','1');
COMMIT;
